...
Title NSC_Builder v0.82. -- Profile: %ofile_name% -- by JulesOnTheRoad
::-----------------------------------------------------
...
REM echo Input "7" to enter ADVANCE mode
...
echo Input "2" to repack list as XCI
echo Input "3" to as NSP with only Unmodified eshop nca files
echo Input "4" to repack list as both T-NSP and XCI
...
if /i "%bs%"=="2" set "vrepack=xci"
if /i "%bs%"=="3" set "vrepack=nsp"
if /i "%bs%"=="3" set "skipRSVprompt=true"
if /i "%bs%"=="4" set "vrepack=cboth"
