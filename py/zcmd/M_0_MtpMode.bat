...
:LegacyMode
call "%cmdfolder%\LEGACY.bat"
exit /B

:GDMode
call "%cmdfolder%\DriveMode.bat"
exit /B
...
:G_INST_GDRIVE
call "%cmdfolder%\MtpInstallRemote.bat"
goto MAIN
...
if /i "%eval%"=="1" ( %pycommand% "%sq_lc%" -lib_call listmanager selector2list -xarg "%prog_dir%MTP1.txt" mode=folder ext="nsp xci nsz xcz" ) 2>&1>NUL
if /i "%eval%"=="2" ( %pycommand% "%sq_lc%" -lib_call listmanager selector2list -xarg "%prog_dir%MTP1.txt" mode=file ext="nsp xci nsz xcz" )  2>&1>NUL
if /i "%eval%"=="3" ( %pycommand% "%sq_lc%" -lib_call mtp.mtpinstaller select_from_local_libraries -xarg "%prog_dir%MTP1.txt" )
if /i "%eval%"=="4" ( %pycommand% "%sq_lc%" -lib_call picker_walker get_files_from_walk -xarg "%prog_dir%MTP1.txt" "extlist=nsp xci nsz xcz" )
...
if /i "%eval%"=="2" ( %pycommand% "%sq_lc%" -lib_call listmanager selector2list -xarg "%prog_dir%MTP1.txt" mode=folder ext="nsp xci nsz" ) 2>&1>NUL
if /i "%eval%"=="3" ( %pycommand% "%sq_lc%" -lib_call listmanager selector2list -xarg "%prog_dir%MTP1.txt" mode=file ext="nsp xci nsz" )  2>&1>NUL
if /i "%eval%"=="4" ( %pycommand% "%sq_lc%" -lib_call mtp.mtpinstaller select_from_local_libraries -xarg "%prog_dir%MTP1.txt" )
if /i "%eval%"=="5" ( %pycommand% "%sq_lc%" -lib_call picker_walker get_files_from_walk -xarg "%prog_dir%MTP1.txt" "extlist=nsp xci nsz xcz" )
...
%pycommand% "%sq_lc%" -lib_call listmanager filter_list "%prog_dir%MTP1.txt","ext=nsp xci nsz","token=False",Print="False"
%pycommand% "%sq_lc%" -lib_call mtp.mtpinstaller loop_install -xarg "%prog_dir%MTP1.txt" "destiny=%medium%" "verification=%MTP_verification%" "%w_folder%" "ch_medium=%MTP_aut_ch_medium%" "check_fw=%MTP_chk_fw%" "patch_keygen=%MTP_prepatch_kg%" "ch_base=%MTP_prechk_Base%" "ch_other=%MTP_prechk_Upd%" "install_mode=%MTP_ptch_inst_spec%" "st_crypto=%MTP_stc_installs%"
...
:F_TR_LOCAL
call "%cmdfolder%\MtpFTLocal.bat"
goto MAIN
:F_TR_GD
call "%cmdfolder%\MtpTransferRemote.bat"
goto MAIN
:F_TR_C_xci_Transfer
call "%cmdfolder%\MtpCxciFTLocal.bat"
goto MAIN
:F_TR_C_mxci_Transfer
call "%cmdfolder%\MtpCmxciFTLocal.bat"
goto MAIN
...
CD /d "%prog_dir%"
echo.
%pycommand% "%sq_lc%" -lib_call mtp.mtp_gdrive update_console_from_gd -xarg "libraries=update" "destiny=%medium%" "exclude_xci=%MTP_exclude_xci_autinst%" "prioritize_nsz=%MTP_prioritize_NSZ%" "%prog_dir%MTP1GD.txt" "verification=%MTP_verification%" "ch_medium=%MTP_aut_ch_medium%" "ch_other=%MTP_prechk_Upd%" "autoupd_aut=%autoupd_aut%"
echo.
ECHO ---------------------------------------------------
ECHO *********** ALL FILES WERE PROCESSED! *************
ECHO ---------------------------------------------------
...
CD /d "%prog_dir%"
echo.
%pycommand% "%sq_lc%" -lib_call mtp.mtpinstaller update_console -xarg "libraries=all" "destiny=%medium%" "exclude_xci=%MTP_exclude_xci_autinst%" "prioritize_nsz=%MTP_prioritize_NSZ%" "%prog_dir%MTP1.txt" "verification=%MTP_verification%" "ch_medium=%MTP_aut_ch_medium%" "ch_other=%MTP_prechk_Upd%" "autoupd_aut=%autoupd_aut%"
...
%pycommand% "%sq_lc%" -lib_call mtp.mtp_game_manager back_up_saves -xarg  %backup_all% %MTP_saves_Inline% %MTP_saves_AddTIDandVer% %romaji%
echo.
ECHO ---------------------------------------------------
ECHO *********** ALL FILES WERE PROCESSED! *************
ECHO ---------------------------------------------------
...
call :program_logo
echo.
%pycommand% "%sq_lc%" -lib_call mtp.mtpinstaller get_installed_info -xarg "" False
echo.
PAUSE
goto DEV_INF
...
call :program_logo
echo.
%pycommand% "%sq_lc%" -lib_call mtp.mtpinstaller get_installed_info -xarg "" True
echo.
PAUSE
goto DEV_INF
...
call :program_logo
echo.
%pycommand% "%sq_lc%" -lib_call mtp.mtpinstaller get_archived_info -xarg False
echo.
PAUSE
goto DEV_INF
...
call :program_logo
echo.
%pycommand% "%sq_lc%" -lib_call mtp.mtpinstaller get_archived_info -xarg True
echo.
PAUSE
goto DEV_INF
