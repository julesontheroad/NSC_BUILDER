...
%pycommand% "%sq_lc%" -lib_call nutdb force_refresh
...
if /i "%bs%"=="2" ( %pycommand% "%sq_lc%" -lib_call workers concurrent_cache )
...
set "token=%bs%"
echo.
%pycommand% "%sq_lc%" -lib_call Drive.Private create_token -xarg "%token%" headless="False"
pause
goto google_drive
