...
%pycommand% "%squirrel%" --strip_lines "%prog_dir%lists/1_2list.txt" "1" "true"
...
%pycommand% "%squirrel%" %buffer% --xml_gen "true" -o "%w_folder%" -tfile "%list_folder%\1_2list.txt" --erase_deltas ""
...
:s_exit_choice
if exist lists/1_2list.txt del lists/1_2list.txt
