...
if /i "%eval%"=="1" ( %pycommand% "%squirrel%" -lib_call listmanager selector2list -xarg "%list_folder%\6_2list.txt" mode=folder ext="nsp xci nsz xcz nsx" ) 2>&1>NUL
if /i "%eval%"=="2" ( %pycommand% "%squirrel%" -lib_call listmanager selector2list -xarg "%list_folder%\6_2list.txt" mode=file ext="nsp xci nsz xcz nsx" ) 2>&1>NUL
if /i "%eval%"=="3" ( %pycommand% "%squirrel%" -lib_call picker_walker select_from_local_libraries -xarg "%list_folder%\6_2list.txt" "extlist=nsp xci nsz xcz nsx" )
if /i "%eval%"=="4" ( %pycommand% "%squirrel%" -lib_call picker_walker get_files_from_walk -xarg "%list_folder%\6_2list.txt" "extlist=nsp xci nsz xcz nsx" )
goto checkagain
echo.
:checkagain
...
if /i "%eval%"=="2" ( %pycommand% "%squirrel%" -lib_call listmanager selector2list -xarg  "%list_folder%\6_2list.txt" mode=folder ext="nsp xci nsz xcz nsx" ) 2>&1>NUL
if /i "%eval%"=="3" ( %pycommand% "%squirrel%" -lib_call listmanager selector2list -xarg  "%list_folder%\6_2list.txt" mode=file ext="nsp xci nsz xcz nsx" )  2>&1>NUL
if /i "%eval%"=="4" ( %pycommand% "%squirrel%" -lib_call picker_walker select_from_local_libraries -xarg "%list_folder%\6_2list.txt" "extlist=nsp xci nsz xcz nsx" )
if /i "%eval%"=="5" ( %pycommand% "%squirrel%" -lib_call picker_walker get_files_from_walk -xarg "%list_folder%\6_2list.txt" "extlist=nsp xci nsz xcz nsx" )
