...
echo -----------------------------------------------
echo REBUILD NSPS BY CNMT ORDER
echo -----------------------------------------------
if exist "%list_folder%\1_5list.txt" goto prevlist
goto manual_INIT
:prevlist
set conta=0
...
if !conta! LEQ 0 ( del "%list_folder%\1_5list.txt" )
endlocal
if not exist "%list_folder%\1_5list.txt" goto manual_INIT
ECHO .......................................................
...
goto prevlist0
:delist
del "%list_folder%\1_5list.txt" 2>&1>NUL
cls
call "%nscb_logos%" "program_logo"
echo -----------------------------------------------
...
ECHO ***********************************************
echo.
%pycommand% "%sq_lc%" -lib_call cmd.cmd_tools userinput -xarg "%list_folder%\1_5list.txt" ext="nsp nsz" userfile="%uinput%"   
set /p eval=<"%uinput%"
set eval=%eval:"=%
setlocal enabledelayedexpansion
echo+ >"%uinput%"
