...
if /i "%eval%"=="1" ( %pycommand% "%sq_lc%" -lib_call picker_walker remote_select_from_cache -xarg "%prog_dir%MTP1GD.txt" )
if /i "%eval%"=="2" ( %pycommand% "%sq_lc%" -lib_call picker_walker remote_select_from_libraries -xarg "%prog_dir%MTP1GD.txt" )
if /i "%eval%"=="3" ( %pycommand% "%sq_lc%" -lib_call picker_walker remote_select_from_walker -xarg "%prog_dir%MTP1GD.txt" "nsp nsz" )
...
if /i "%eval%"=="2" ( %pycommand% "%sq_lc%" -lib_call picker_walker remote_select_from_cache -xarg "%prog_dir%MTP1GD.txt" )
if /i "%eval%"=="3" ( %pycommand% "%sq_lc%" -lib_call picker_walker remote_select_from_libraries -xarg "%prog_dir%MTP1GD.txt" )
if /i "%eval%"=="4" ( %pycommand% "%sq_lc%" -lib_call picker_walker remote_select_from_walker -xarg "%prog_dir%MTP1GD.txt" "nsp nsz" )
if /i "%eval%"=="c" ( %pycommand% "%sq_lc%" -lib_call workers concurrent_cache )
...
call :program_logo
CD /d "%prog_dir%"
%pycommand% "%sq_lc%" -lib_call mtp.mtp_gdrive loop_install -xarg "%prog_dir%MTP1GD.txt" "destiny=%medium%" "%w_folder%" "ch_medium=%MTP_aut_ch_medium%" "check_fw=%MTP_chk_fw%" "patch_keygen=%MTP_prepatch_kg%" "ch_base=%MTP_prechk_Base%" "ch_other=%MTP_prechk_Upd%" "truecopy=%MTP_pdrive_truecopy%"
echo.
ECHO ---------------------------------------------------
