			...
			if type(nca) == Nca:
				if 	str(nca.header.contentType) == 'Content.CONTROL':
					...
					for f in nca:
						...
						nacp.par_getUserAccountSwitchLock(f.readInt8('little'))		
						nacp.par_getAddOnContentRegistrationType(f.readInt8('little'))						
						nacp.par_getContentType(f.readInt8('little'))	
						nacp.par_getParentalControl(f.readInt8('little'))
						nacp.par_getScreenshot(f.readInt8('little'))
						nacp.par_getVideoCapture(f.readInt8('little'))
						nacp.par_dataLossConfirmation(f.readInt8('little'))
						nacp.par_getPlayLogPolicy(f.readInt8('little'))
						nacp.par_getPresenceGroupId(f.readInt64('little'))
						...
						print('...............................')							
						for i in range(12):
							age=nacp.par_getRatingAge(f.readInt8('little'),i)
						f.seek(offset+0x3060)							
						print('...............................')					
						print('NACP ATTRIBUTES')
						print('...............................')	
						nacp.par_getDisplayVersion(f.read(0xF))		
						f.seek(offset+0x3070)							
						nacp.par_getAddOnContentBaseId(f.readInt64('little'))
						f.seek(offset+0x3078)							
						nacp.par_getSaveDataOwnerId(f.readInt64('little'))
						f.seek(offset+0x3080)							
						nacp.par_getUserAccountSaveDataSize(f.readInt64('little'))	
						f.seek(offset+0x3088)								
						nacp.par_getUserAccountSaveDataJournalSize(f.readInt64('little'))	
						f.seek(offset+0x3090)	
						nacp.par_getDeviceSaveDataSize(f.readInt64('little'))	
						f.seek(offset+0x3098)	
						nacp.par_getDeviceSaveDataJournalSize(f.readInt64('little'))	
						f.seek(offset+0x30A0)	
						nacp.par_getBcatDeliveryCacheStorageSize(f.readInt64('little'))		
						f.seek(offset+0x30A8)	
						nacp.par_getApplicationErrorCodeCategory(f.read(0x07))	
						f.seek(offset+0x30B0)
						nacp.par_getLocalCommunicationId(f.readInt64('little'))	
						f.seek(offset+0x30F0)
						nacp.par_getLogoType(f.readInt8('little'))							
						nacp.par_getLogoHandling(f.readInt8('little'))		
						nacp.par_getRuntimeAddOnContentInstall(f.readInt8('little'))	
						nacp.par_getCrashReport(f.readInt8('little'))	
						nacp.par_getHdcp(f.readInt8('little'))		
						nacp.par_getSeedForPseudoDeviceId(f.readInt64('little'))	
						f.seek(offset+0x3100)			
						nacp.par_getBcatPassphrase(f.read(0x40))	
						f.seek(offset+0x3148)			
						nacp.par_UserAccountSaveDataSizeMax(f.readInt64('little'))						
						f.seek(offset+0x3150)			
						nacp.par_UserAccountSaveDataJournalSizeMax(f.readInt64('little'))
						f.seek(offset+0x3158)			
						nacp.par_getDeviceSaveDataSizeMax(f.readInt64('little'))
						f.seek(offset+0x3160)			
						nacp.par_getDeviceSaveDataJournalSizeMax(f.readInt64('little'))							
						f.seek(offset+0x3168)			
						nacp.par_getTemporaryStorageSize(f.readInt64('little'))		
						nacp.par_getCacheStorageSize(f.readInt64('little'))			
						f.seek(offset+0x3178)		
						nacp.par_getCacheStorageJournalSize(f.readInt64('little'))							
						nacp.par_getCacheStorageDataAndJournalSizeMax(f.readInt64('little'))		
						f.seek(offset+0x3188)	
						nacp.par_getCacheStorageIndexMax(f.readInt64('little'))		
						nacp.par_getPlayLogQueryableApplicationId(f.readInt64('little'))		
						f.seek(offset+0x3210)	
						nacp.par_getPlayLogQueryCapability(f.readInt8('little'))	
						nacp.par_getRepair(f.readInt8('little'))	
						nacp.par_getProgramIndex(f.readInt8('little'))	
